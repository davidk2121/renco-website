        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-14">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="/bathroom-remodel-gig-harbor" className="font-body text-sm text-[#9A9388] hover:text-[#C9A96A] transition-colors">Bathroom Remodel Gig Harbor</a></li>
              <li><a href="/bathroom-remodel-tacoma" className="font-body text-sm text-[#9A9388] hover:text-[#C9A96A] transition-colors">Bathroom Remodel Tacoma</a></li>
              <li><a href="/bathroom-remodel-seattle" className="font-body text-sm text-[#9A9388] hover:text-[#C9A96A] transition-colors">Bathroom Remodel Seattle</a></li>
              <li><a href="/kitchen-remodel-gig-harbor" className="font-body text-sm text-[#9A9388] hover:text-[#C9A96A] transition-colors">Kitchen Remodel Gig Harbor</a></li>
              <li><a href="/kitchen-remodel-seattle" className="font-body text-sm text-[#9A9388] hover:text-[#C9A96A] transition-colors">Kitchen Remodel Seattle</a></li>
